...
{
    $admins = Admin::join('permissions', 'permissions.permission_id', '=', 'admins.permission_id')->get();
...
public function create()
{
    ...
    return view('admin.portal_admins.create')
...
public function store(Request $request)
{
    ...
    $data['sender_email'] = 'support@excelprosrecruit.com';
    $data['sender_name'] = 'RecruitPro';

    if(Mail::send('email.admin_account_created',
    array(
        'subject' => 'You are now an admin on RecruitPro',
...
public function update_password(Request $request)
{
    ...
    array(
        ...
        'recipient_password' => $password,
        'site_link' => 'http://recruitpro.digitalcognition.com.ng/admin'
    ), 
    function($message) use ($data) {
        $message->from($data['sender_email'], $data['sender_name']);
        $message->to($data['email'])
