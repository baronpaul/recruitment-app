        ...
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <div class="job-detail-wrapper">
                    ...
                    <div class="">
                        <form action="{{ route('profile.update_professional_association') }}" method="post">
                            
                            {{ csrf_field() }}

                            <input type="hidden" name="ps_id" value="{{ $professional_association->ps_id }}">
                                            ...
                                            <div class="row school_itm">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="professional_body" value="{{ $professional_association->professional_body }}" class="form-control" 
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="qualification" value="{{ $professional_association->qualification }}" class="form-control" 
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" name="date_attained" value="{{ $professional_association->date_attained }}" class="form-control" >
                                                    </div>
                                                </div>
                                            </div>
                                        <td>
