        ...
        <div class="row">
            <div class="col-md-9">
                <div class="row">
                    ...
                    <div class="col-md-3"><button type="button" class="btn btn-info add-extra-school">Add Institution</button></div>
                </div>

                <div class="job-detail-wrapper">
                    
                    <div class="">
                        <form action="{{ route('job_application.store_education') }}" method="post">
