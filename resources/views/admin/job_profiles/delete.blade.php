                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 layout-spacing">
                    <div class="widget widget-chart-three">
                        <div class="widget-heading">
                            <div class="">
                                <h5 class="">Delete Job Profile</h5>
                            </div>
                        </div>

                        <div class="widget-content">
                            <div class="form_wrap">
                                <form action="{{ route('admin.job_profiles.destroy') }}" method="POST" class="forms-sample">
                                    {{ csrf_field() }}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                value="{{ $job_profile->job_title }}" placeholder="Job Title" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                value="{{ $job_profile->department }}" placeholder="Department" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                value="{{ $job_profile->location }}" placeholder="Location" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                value="{{ $job_profile->reporting_to }}" placeholder="Reporting To" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                placeholder="Reason For Vacancy" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                placeholder="Basic Educational Qualification" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                placeholder="Professional Qualifications" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                placeholder="Years of Relevant Experience" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                placeholder="Annual Basic Salary" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                placeholder="Fringe Benefits" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                placeholder="Other Benefits" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                placeholder="Prepared By" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                placeholder="Position Held" readonly>
                                            </div>
                                        </div>

                                        <div class="col-md-12">
                                            <button type="submit" class="btn btn-primary mr-2">Delete Job Profile</button>
